...
public class ApprovingAdapter extends RecyclerView.Adapter<ApprovingAdapter.ViewHolder>{
    private ArrayList<ApprovedModel> listdata;
    private ArrayList<String> listdataIds;
    private Context context;

    // RecyclerView recyclerView;
    public ApprovingAdapter(ArrayList<ApprovedModel> listdata, ArrayList<String> listdataIds, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.approving_item, parent, false);
